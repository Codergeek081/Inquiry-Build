...
dotenv.config();
import { viewAllDepartments, viewAllRoles, viewAllEmployees, addDepartment, addRole, addEmployee, updateEmployeeRole } from "./queries.js";
...
async function companyCMS(sql) {
    ...
    switch (action) {
        ...
        case "Add Employee": {
            ...
            await addEmployee(answers.firstName, answers.lastName, parseInt(answers.roleId), answers.managerId ? parseInt(answers.managerId) : null, sql);
            break;
        }
